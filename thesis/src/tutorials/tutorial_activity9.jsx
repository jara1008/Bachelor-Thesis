    ...
    function CoinRowUpperLeft() {
        return (
            <div className="coin-stack-A9">
                <div className={`coin-A9 ${tutorialProgress === 1 ? 'highlighted' : ''}`} 
                ...
                {difficulty==='easy' && 
                    <div className={`coin-A9 ${tutorialProgress === 2 ? 'highlighted' : ''}`} 
        ...
        return (
            <div className="coin-stack-A9">
                ...
                {difficulty==='easy' && 
                    ...
                    {difficulty==='easy' &&
                    <div className={`coin-A9`} readOnly={true}
        ...
        <div className="container">
            <div className="white-box-large">
                ...
                <div className="row-wrapper" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-end', width: '100%' }}>
                    ...
                    {difficulty === 'hard' && (<button onClick={continueTutorial} 
                ...
                <div className="coin-row-A9" style={{ '--top': '60%' }}>
                    {<span className='symbol-A9' style={{ '--left': '-5%', '--top': '17%' }}>=</span>}
                    <CoinRowLowerLeft />
                    {tutorialProgress<=2 && <span className='symbol-A9' style={{ '--left': '-2%', '--top': '68%' }}>-</span>}
                    {tutorialProgress>2 && <span className={`symbol-A9 ${(difficulty==='easy' && tutorialProgress===3) || (difficulty==='hard' && tutorialProgress === 4) ? 'highlighted' : ''}`} style={{ '--left': '-2%', '--top': '40%' }}>-</span>}
                    <CoinRowLowerRight />
                </div>
