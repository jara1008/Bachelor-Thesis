    ...
    <div className="container">
      ...
      >
        ...
        <div className="cube-rows-A2">
          <div
            className={`cube-row-A2 ${tutorialProgress === 1 ? "highlighted" : ""}`}
          >
            {Array.from({ length: numCubesFirstRow }, (_, index) => (
              <div
                key={index}
                className={`cube-A2 ${difficulty === "hard" && tutorialProgress === 4 && index === numCubesFirstRow - 1 ? "highlighted" : ""}`}
              >
          ...
          <div
            className={`cube-row-A2 ${tutorialProgress === 2 ? "highlighted" : ""}`}
          >
        ...
        <div className="info-A2">
          <span
            className={`number-label ${tutorialProgress === 1 ? "highlighted" : ""}`}
          >
            {numCubesFirstRow}
          </span>
          <input
          ...
          />
          <span
            className={`number-label ${tutorialProgress === 2 ? "highlighted" : ""}`}
          >
            {numCubesSecondRow}{" "}
          </span>
        </div>
        <div>
          <div className="button-container-A2">
            <button
              className={`operator-button-A2 ${tutorialProgress === 3 ? "highlighted" : ""}`}
              disabled="true"
              style={{
            ...
            <button
              ...
              style={{ cursor: tutorialProgress !== 3 ? "default" : "pointer" }}
