...
function TutorialActivity5({ difficulty, onComplete }) {
    ...
    const handleInputChange = (e) => {
        ...
        else if (difficulty==='hard' && tutorialProgress === 1 && value === '13') {
            setTutorialProgress(2); 
            setInputDisabled(true); 
            setButtonText("Prüfen");
        }
        ...
        <div className="container">
            ...
            <div className="white-box-regular" style={{ boxShadow: "var(--default-highlight)" }} >
                ...
                {difficulty==='easy' && showHint && tutorialProgress === 1 && (
                    <div className="info-A5" style={{ fontSize: '2vw' }}>Tipp: Die Zahl ist 6</div>
                )}
                {difficulty==='hard' && showHint && tutorialProgress === 1 && (
                    <div className="info-A5" style={{ fontSize: '2vw' }}>Tipp: Die Zahl ist 13</div>
                )}
                <button
                    onClick={continueTutorial}
                    className={`button-default ${
                        tutorialProgress===0 || tutorialProgress===2 ? 'highlighted' : ''
                    }`}
