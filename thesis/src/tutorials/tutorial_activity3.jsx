...
function TutorialActivity3({ difficulty, onComplete }) {
    ...
    const continueTutorial = () => {
        ...
        if ((tutorialProgress === 4 && difficulty === 'easy') || (tutorialProgress === 7 && difficulty === 'hard')){
            onComplete();
        }
    ...
    function CoinRowUpperLeft() {
        return (
            <div className="coin-stack-A3">
                <div className={`coin-A3 ${tutorialProgress === 1 ? 'highlighted' : ''}`} 
                ...
                <div className={`coin-A3 ${tutorialProgress === 2 ? 'highlighted' : ''}`} 
                ...
                {difficulty==='easy' &&
                    <div className={`coin-A3`} readOnly={true}
                ...
                {difficulty==='hard' && 
                    <div
                        ...
                        onClick={tutorialProgress === 4 ? () => continueTutorial() : undefined}
                    >
                    1
                    </div>
                }
                ...
                {difficulty==='hard' && 
                    <div
                        ...
                        onClick={tutorialProgress === 5 ? () => continueTutorial() : undefined}
                    >
                    1
                    </div>
                }
    ...
    function CoinRowLowerRight() {
        return (
            <div className="coin-stack-A3">
                ...
                {difficulty==='hard' && tutorialProgress > 3 && tutorialProgress < 5 && (
                    <div
                        className={`coin-A3`}
                        style={{ cursor: 'default' }}>
                        1
                ...
                {difficulty==='hard' && tutorialProgress > 3 && tutorialProgress < 6 && (
                    <div
                        className={`coin-A3`}
                        style={{ cursor: 'default' }}>
                        1
            ...
            <div className="white-box-large">
                ...
                {difficulty === 'hard' && (
                    <div style={{ display: "flex", justifyContent: "space-around", width: "100%" }}>
                        <button  className="header-button" style={{ left: "25%", marginTop: "2vh" }}>
                            Tauschen
                        </button>
                        <button className={`header-button ${tutorialProgress === 3 ? 'highlighted' : ''}`} style={{ left: "75%", marginTop: "2vh" }}
                ...
                <div className="button-container-A3">
                    <button
                        ...
                        style={{
                            cursor:
                                (difficulty === 'easy' && tutorialProgress === 3) ? 'not-allowed' : 'default' ||
                                (difficulty === 'hard' && tutorialProgress === 6) ? 'pointer' : 'default'
                        }}                        
                        onClick={() => continueTutorial()}
                    >
                        {'<'}
                    ...
                    <button
                        className={`operator-button-A2 ${(difficulty==='easy' && tutorialProgress===3) || (difficulty==='hard' && tutorialProgress===6) ? 'highlighted' : ''}`}
                        disabled={'true'} 
                        style={{cursor: (difficulty==='easy' && tutorialProgress===3) || (difficulty==='hard' && tutorialProgress===6) ? 'not-allowed' : 'default'}}
                    >
                        {'='}
                    </button>
                    <button
                        ...
                        style={{
                            cursor:
                                (difficulty === 'easy' && tutorialProgress === 3) ? 'pointer' : 'default' ||
                                (difficulty === 'hard' && tutorialProgress === 6) ? 'not-allowed' : 'default'
                        }}                        
                        onClick={() => continueTutorial()}
                    >
                        {'>'}
                ...
                <button
                    ...
                    className={`button-default ${((difficulty==='easy' && tutorialProgress===4) 
                        ...
                        disabled={
                            ...
                            (difficulty === 'hard' && [1, 2, 3, 4, 5].includes(tutorialProgress))
                        }
