    ...
    return (
      <>
        <img
          ...
          onClick={(e) =>
            handleStarClick(e, { ...leftCloudPositions[0], cloudSide: "left" })
          }
          onTouchStart={(e) =>
            handleTouchStart(e, { ...leftCloudPositions[0], cloudSide: "left" })
          }
        />
        <img
          src={star}
        ...
        <img
          ...
          onClick={(e) =>
            handleStarClick(e, { ...rightCloudPositions[1], cloudSide: "left" })
          }
          onTouchStart={(e) =>
            handleTouchStart(e, {
              ...rightCloudPositions[1],
              cloudSide: "left",
            })
          }
        />
          ...
          {difficulty === "easy" && (
            <input
              ...
              style={{
                ...
                pointerEvents: "none",
                boxShadow:
                  tutorialProgress === 2 ? "0 0 10px 5px #ffbf00" : "none",
          ...
          {difficulty === "hard" && (
            <div>
              <div className="button-container-A1">
                <button
                  className={`operator-button-A1 ${tutorialProgress === 2 ? "highlighted" : ""}`}
                  style={{
                    cursor: tutorialProgress === 2 ? "pointer" : "default",
                  }}
