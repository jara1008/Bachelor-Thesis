        ...
        <div>
            <img src={tree} alt='tree'
                style={{
                    ...
                    boxShadow: tutorialProgress===2 || tutorialProgress===3 ? '0 0 10px 5px #ffbf00' : 'none',
            ...
            <div className="number-line">
                {[-7, -6, -5, -4, -3, -2, -1].map((num, index) => (
                    <div key={`left-${index}`} 
                        ...
                        {Math.abs(num)}
                        {num === carIndex && <img src={car} alt="car" 
    ...
    const renderRectangles = () => {
        return (
            <div className="rectangle-container">
                <div className={`rectangle2 ${tutorialProgress === 1 ? 'highlighted' : ''}`}>
                    <button
                        className="square"
                        style={{
                ...
                <div className={`rectangle2 ${tutorialProgress === 2 ? 'highlighted' : ''}`}>
                    <button
                        className="square"
                        style={{
                ...
                <div className={`rectangle2 ${tutorialProgress === 3 ? 'highlighted' : ''}`}>
                    <button
                        className="square"
                        style={{
                            backgroundColor: '#eceefa',
                            ...
                            <div className='rectangle2' key={[id, id2]} style={{
                                ...
                                {id2 - 5 === car2d[0] && 5 - id === car2d[1] && (
                                    <img src={car} alt="car" style={{
                                        ...
                                        height: '2vw',
                                        zIndex: 1,
                                        boxShadow: tutorialProgress===1 || tutorialProgress===2 || tutorialProgress===3 ? '0 0 10px 5px #ffbf00' : 'none',
                                        transition: 'box-shadow 0.3s ease-in-out'
                                    }} />
                                )}
                                {id === 6 && id2 === 6 && (
                                ...
                                {id === 6 && id2 === 11 && (
                                    <>
                                        <div className={`triangle right ${tutorialProgress === 2 ? 'highlighted' : ''}`}></div>
                                        <div className={`plus-sign right ${tutorialProgress === 3 ? 'highlighted' : ''}`}>+</div>
                                    </>
                                )}
                                {id === 6 && id2 === 1 && (
                                    <>
                                ...
                                {id2 === 6 && id === 11 && (
                                    <>
                                        <div className={`triangle down ${tutorialProgress === 2 ? 'highlighted' : ''}`}></div>
                                        <div className={`plus-sign down ${tutorialProgress === 3 ? 'highlighted' : ''}`}>-</div>
                                    </>
                                )}
                                {id2 === 6 && id === 1 && (
                                    <>
                                ...
                                {id === 6 && id2 !== 0 && id2 !== 6 && (
                                    <div style={{
                                        ...
                                        boxShadow: (tutorialProgress===1 || tutorialProgress===3) && (id2-6)===3 ? '0 0 10px 5px #ffbf00' : 'none',
                                        transition: 'box-shadow 0.3s ease-in-out'
                                    }}>
                                        {Math.abs(id2 - 6)}
                                    </div>
                                ...
                                {id2 === 6 && id !== 0 && id !== 6 && (
                                    <div style={{
                                        ...
                                        boxShadow: (tutorialProgress===1 || tutorialProgress===3) && (6-id)===-2 ? '0 0 10px 5px #ffbf00' : 'none',
                                        transition: 'box-shadow 0.3s ease-in-out'
                                    }}>
                                        {Math.abs(6 - id)}
                                    </div>
    ...
    const renderRectanglesHard = () => {
        return (
            <div className="rectangle-container-hard" style={{ display: 'flex', flexDirection: 'column' }}>
                <div className={`rectangle2 ${tutorialProgress === 1 ? 'highlighted' : ''}`}>
                    <button className="squareHard" disabled={'true'} style={{cursor: tutorialProgress!==1 ? 'default' : 'not-allowed'}}>
                    ...
                    <button className="squareHard" 
                        disabled={tutorialProgress!==1} 
                        style={{cursor: tutorialProgress!==1 ? 'default' : 'pointer', backgroundColor: tutorialProgress < 2 ? '#eceefa' : '#BFC4F2'}}
                        onClick={() => continueTutorial()}>
                        <div style={{ display: 'flex', color: 'black' }}></div>
                        <div>
                ...
                <div className={`rectangle2 ${tutorialProgress === 2 ? 'highlighted' : ''}`}>
                    <button className="squareHard" disabled={'true'} style={{cursor: tutorialProgress!==2 ? 'default' : 'not-allowed'}}>
                    ...
                    <button className="squareHard"
                        disabled={tutorialProgress!==2} 
                        style={{cursor: tutorialProgress!==2 ? 'default' : 'pointer', backgroundColor: tutorialProgress < 3 ? '#eceefa' : '#BFC4F2',}}
                        onClick={() => continueTutorial()}>
                        <div style={{ display: 'flex', color: 'black' }}>
                            <div>&rarr;</div>
                            <div>&darr;</div>
                ...
                <div className={`rectangle2 ${tutorialProgress === 3 ? 'highlighted' : ''}`}>
                    <button className="squareHard" disabled={'true'} style={{cursor: tutorialProgress!==3 ? 'default' : 'not-allowed'}}>
                        <div style={{ display: 'flex', color: 'black' }}></div>
                        <div>
                            <span style={{ color: 'black' }}>-3</span>,
                            <span style={{ color: 'black' }}>2</span>
                    ...
                    <button className="squareHard"
                        disabled={tutorialProgress!==3} 
                        style={{cursor: tutorialProgress!==3 ? 'default' : 'pointer', backgroundColor: tutorialProgress < 4 ? '#eceefa' : '#BFC4F2',}}
                        onClick={() => continueTutorial()}>
                        <div style={{ display: 'flex', color: 'black' }}></div>
                        <div>
                            <span style={{ color: 'black' }}>3</span>,
    ...
    return (
        <div className="container" >
            ...
            <div className="white-box-regular" style={{ boxShadow: "var(--default-highlight)" }} >
                <HomeLink />
                {difficulty === "easy" && <>
                    <span className="title-text">{tutorialStepsEasy[tutorialProgress]['message']}</span>
                    {renderNumberLine()}
                    {renderRectangles()}
                </>}
                {difficulty === "hard" && <div>
                    <span className="title-text">{tutorialStepsHard[tutorialProgress]['message']}</span>
                ...
                <button
                    ...
                    disabled={tutorialProgress===1 || tutorialProgress===2 || tutorialProgress===3}
                    style={{ top: `${checkButtonTop}%`, 
                            left: '50%', 
                            cursor: (tutorialProgress===1 || tutorialProgress===2 || tutorialProgress===3) ? 'default' : 'pointer' }}
                >
                    {buttonText}
                </button>
            </div>
