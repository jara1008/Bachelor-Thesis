...
function Overview() {
  /* creates the nine rectangles, for each level one */
  /* handles the routing to the difficultySelection.jsx component upon clicking on a rectangle */
  ...
  /* tracks the dot positions to set the rocket to the left side of a dot */
  ...
  /* AI: chatGPT helped with accessing the localStorage */
  ...
  /* renders the progress line on the left side of the screen */
  useEffect(() => {
    const topOffset = 8;
  ...
  /* updates the position if the highest unlocked level nr increased */
  useEffect(() => {
    if (
  ...
  /* handles the pdf download if one clicks on "Mehr Info" in the top right hand corner */
  /* AI: this function was generated by ChatGPT, because I had no clue how to do it */
  ...
  /* renders the rectangles, the progressbar and the rocket */
  return (
